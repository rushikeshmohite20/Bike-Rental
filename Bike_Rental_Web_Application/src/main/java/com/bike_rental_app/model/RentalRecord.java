...
//    @JsonIgnore
    ...
    public int isExtraHelmet() {
        return extraHelmet;
    }

    public void setExtraHelmet(int extraHelmet) {
	...
	public RentalRecord(Long rentalRecordId, User user, Bike bike, LocalDate rentalStartDate, LocalDate rentalEndDate,
			LocalDate bookingDate, int extraHelmet, boolean paymentConfirmation) {
		super();
		this.rentalRecordId = rentalRecordId;
		this.user = user;
		this.bike = bike;
