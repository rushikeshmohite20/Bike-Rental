package com.bike_rental_app.config;
...
import com.bike_rental_app.jwt.JwtAuthenticationFilter;
import com.bike_rental_app.service.UserDetailsServiceImpl;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                .cors()  // Enable CORS
                .and()   // ⬅️ Important: go back to HttpSecurity
